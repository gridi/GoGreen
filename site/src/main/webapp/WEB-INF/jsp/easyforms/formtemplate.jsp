...
<c:choose>
  ...
  <c:when test="${success eq 'dummysuccess'}">
    <div id="content">
    	<fmt:message key="easyforms.formtemplate.thankyou.form"/>
    </div>
  </c:when>
  <c:otherwise>
...
<%--
Contributions for the datepicker
--%>

<hst:headContribution category="css">
  <link rel="stylesheet" href="<hst:link path="css/jquery-ui-1.10.3.custom.css"/>" type="text/css"/>
</hst:headContribution>
